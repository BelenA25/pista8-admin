        ...
        >
          <NavigationMenu>
            <NavigationMenuList className="flex flex-col space-y-6 ">
              ...
              {["Fundadores", "Partners", "Suscripciones", "Noticias"].map(
                (item) => (
                  <NavigationMenuItem
                    key={item}
                  ...
                  >
                    ...
                    >
                      <span>
                        {item === "Fundadores" && (
                          <BriefcaseIcon className="h-4 w-4 mt-1" />
                        )}
                        {item === "Partners" && (
                          <HandshakeIcon className="h-4 w-4 mt-1" />
                        )}
                        {item === "Suscripciones" && (
                          <MailIcon className="h-4 w-4 mt-1" />
                        )}
                        {item === "Noticias" && (
                          <NewspaperIcon className="h-4 w-4 mt-1" />
                        )}
                      </span>
                      <span>{item}</span>
                    </a>
